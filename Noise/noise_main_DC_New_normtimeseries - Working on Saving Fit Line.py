...
path_csv = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\csv_file"
# specify the location of the converted text file
path_text = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\text_file"
# specify the location of the normalized time series
path_norm_ts = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\norm_ts_file"
# directory for detrended time series
path_detrend = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\detrend_file"
# directory for decimated time series
path_DTS = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\dts_file"
# directory for decimated time series AFTER ZERO PADDING
path_DTS_padding = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\dts_padding_file"
# specify the location for the estimated PSD file
path_psd = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\psd_file"
# specify the location for the estimated PSD Fit file
path_psdfit = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\psdfit_file"
# specify the location for the estimated PSD file
path_psdn = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy\psdn_file"
...
ipolyfit = np.polyfit(t,inorm,10)
...
plot_signal_time_series(t, inorm, idetrend, plot=True) #Can set True/False
...
plot_decimated_signal_time_series(t_new, inorm, plot=True)
...
def psdfit_file(_write=False):
    if _write:
        # creates the text file of calculated spectral density
        psdfit_file_format = 'psdfit_'+str(filenumber.zfill(3))+'.txt'
        FileToWrite = open(path_psdfit + os.sep + psdfit_file_format, 'w')
        FileToWrite.write("f_FIT" + "\t" + "Sxn_Fit" + "\n" )
        for idx, freq in enumerate(f_Fit):
            FileToWrite.write(str(round(freq, 5)) +"\t"+ str(Sxn_Fit[idx]/(iavg)) + "\n")       
        FileToWrite.close()

psdfit_file(_write=True) 
...
path_NoiseData = r"C:\Users\Nicholas\Desktop\1-26-2023 - Copy"
