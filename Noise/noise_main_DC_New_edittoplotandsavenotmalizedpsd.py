...
path_csv = r"C:\Users\Nicholas\Desktop\6-1-2022\csv_file"
# specify the location of the converted text file
path_text = r"C:\Users\Nicholas\Desktop\6-1-2022\text_file"
# directory for detrended time series
path_detrend = r"C:\Users\Nicholas\Desktop\6-1-2022\detrend_file"
# directory for decimated time series
path_DTS = r"C:\Users\Nicholas\Desktop\6-1-2022\dts_file"
# directory for decimated time series AFTER ZERO PADDING
path_DTS_padding = r"C:\Users\Nicholas\Desktop\6-1-2022\dts_padding_file"
# specify the location for the estimated PSD file
path_psd = r"C:\Users\Nicholas\Desktop\6-1-2022\psd_file"
# specify the location for the estimated PSD file
path_psdn = r"C:\Users\Nicholas\Desktop\6-1-2022\psdn_file"
...
ipolyfit = np.polyfit(t,i,10)

polyfitcurvei = np.polyval(ipolyfit,t)

idetrend = i - polyfitcurvei
...
def plot_decimated_signal_time_series(time, i, plot=False):
    if plot:
        ...
        # Remove any trend present on  vx and vy fluctuations.
        ax.plot(time, i, c="r", label="Signal + Background")
...
def psdn_plot(plot=False):
    if plot:
        fig, ax = plt.subplots(1, 1, figsize=(7, 7), dpi=150)
        ax.loglog(fx, Sx/(iavg**2), c="g", lw=2.0, label="PSD (normalized)")
        #ax.loglog(fy, Sxn, c="g", lw=2.0, label="PSD (normalized)")
        ax.set_xlabel(r'f [Hz]', fontsize=15)
...
def psdn_file(_write=False):
    if _write:
        ...
        for idx, freq in enumerate(fx):
            FileToWrite.write(str(round(freq, 5)) +"\t"+ str((Sx[idx])/(iavg**2)) + "\n")       
        FileToWrite.close()
...
path_NoiseData = r"C:\Users\Nicholas\Desktop\6-1-2022"
